...
export class Cerebras extends Core.APIClient {
   ...
   * @param {string} [opts.baseURL=process.env['CEREBRAS_BASE_URL'] ?? https://d1n704mb908frr.cloudfront.net/dev/] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      cerebrasAPIKey,
      ...opts,
      baseURL: baseURL || `https://d1n704mb908frr.cloudfront.net/dev/`,
    };
